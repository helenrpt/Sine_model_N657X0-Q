...
#define AI_SINE_MODEL_MODEL_SIGNATURE     "0xe00875cac19da4053a253876552e7d6c"
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_sine_model_activations_map, 1, params)) {
    ...
    serving_default_dense_3_input0_output_array.data = AI_PTR(g_sine_model_activations_map[0] + 64);
    serving_default_dense_3_input0_output_array.data_start = AI_PTR(g_sine_model_activations_map[0] + 64);
    gemm_0_output_array.data = AI_PTR(g_sine_model_activations_map[0] + 0);
    gemm_0_output_array.data_start = AI_PTR(g_sine_model_activations_map[0] + 0);
    nl_0_nl_output_array.data = AI_PTR(g_sine_model_activations_map[0] + 0);
    nl_0_nl_output_array.data_start = AI_PTR(g_sine_model_activations_map[0] + 0);
    gemm_1_output_array.data = AI_PTR(g_sine_model_activations_map[0] + 64);
    gemm_1_output_array.data_start = AI_PTR(g_sine_model_activations_map[0] + 64);
    nl_1_nl_output_array.data = AI_PTR(g_sine_model_activations_map[0] + 0);
    nl_1_nl_output_array.data_start = AI_PTR(g_sine_model_activations_map[0] + 0);
    gemm_2_output_array.data = AI_PTR(g_sine_model_activations_map[0] + 64);
    gemm_2_output_array.data_start = AI_PTR(g_sine_model_activations_map[0] + 64);
    return true;
  }
